                        ...
                        <div class="collapse show" id="collapsePages" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <div class="collapse show" id="collapseReservas" data-bs-parent="#collapseLibros">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link active" href="reservasPendientes.php">Reservas Pendientes</a>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item fw-bold">Reservas pendientes</li>
                    </ol>
                    <?php echo ($_SESSION['tipoUsuario'] != 'Administrador') ? '<!-- Boton Crear Reserva Nueva --><button class="btn btn-primary mb-3" id="reservaLibros" name="' . $_SESSION['idUsuario'] . '">Reservar Libros</button>' : ""; ?>
                    <!-- Tabla -->
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="tablaEmpleados">
                                ...
                                <tbody>
                                    <?php foreach ($datos as $row): if ($row['estadoReserva'] == "En espera") {  ?>
                                            <tr>
                                                <td><?php echo $row['idReserva'] ?></td>
                                                <td><?php echo $row['nombreUsuario'] ?></td>
                                                <td><?php echo $row['apellidoUsuario'] ?></td>
                                                <td><?php echo '<span class="badge bg-warning fs-6 text-black p-2"><i class="bi bi-clock"></i> ' . $row['estadoReserva'] . '</span>'; ?></td>
                                                ...
                                                <td><?php
                                                    echo ($_SESSION['tipoUsuario'] == 'Administrador') ? '<button class="btn btn-success me-2" onclick="sweetAprobarReserva(' . $row['idReserva'] . ')"><i class="bi bi-check-circle"></i> Aprobar</button>' : "";
                                                    echo '<button class="btn btn-danger" onclick="sweetCancelarReserva(' . $row['idReserva'] . ',`' . $row['tipoUsuario'] . '`)">' . (($_SESSION['tipoUsuario'] == 'Administrador') ? '<i class="bi bi-x-circle"></i> Rechazar' : '<i class="bi bi-x-circle"></i> Cancelar') . '</button>';
                                                    ?></td>
                                            </tr>
                                    <?php }
                                    endforeach ?>
